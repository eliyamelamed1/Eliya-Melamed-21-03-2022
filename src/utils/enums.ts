export const endpoints = ({ locationKey, apikey, q }: { locationKey?: string; apikey?: string; q?: string }) => ({
    ...
    currentTemp: `https://dataservice.accuweather.com/currentconditions/v1/${locationKey}?apikey=${apikey}&language=en-us&details=false`,
    geoPositionSearch: `https://dataservice.accuweather.com//locations/v1/cities/geoposition/search?apikey=${apikey}&q=${q}`,
});
